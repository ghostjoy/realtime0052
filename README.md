...
- `2026 YTD 前十大股利型、配息型 ETF`：以 2026/01/01 至今區間計算前十大台股高股息主題 ETF（依 TWSE 官方 `主題/因子`）（卡片頁）
...
- `2026 YTD 主動式 ETF`：台股主動式 ETF 的 2026 YTD Buy & Hold 績效卡，依 TWSE 官方 `證券類別 = 主動式ETF` 建立母體，含 Benchmark 對照圖
...
2. 再切到 `2026 YTD 前十大 ETF`，看 `YTD績效(%) / 2025績效(%) / 大盤超額(%)`。
