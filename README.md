...
3. 想看主動式 ETF 就到 `2026 YTD 主動式 ETF`，同樣可用 `更新最新市況` + Benchmark 對照卡。
4. 想看 ETF 內部強弱就到 `00910 / 00935 / 00993A / 0050 / 0052` 熱力圖，先按 `更新 成分股` 再執行回測。
5. 想看規則化組合再進 `ETF 輪動策略`，比較策略曲線、基準曲線與 ETF 池等權買進持有。
6. 任何頁面若看到舊結果，先按該頁 `更新最新市況` 或 `重新計算` 再判讀。
...
- `app.py`：Streamlit UI 主流程（即時看盤 / 回測工作台 / 2025 前十大 ETF / 2026 YTD 前十大 ETF / 2026 YTD 主動式 ETF / ETF 輪動策略 / 00910 熱力圖 / 00935 熱力圖 / 00993A 熱力圖 / 0050 熱力圖 / 0052 熱力圖 / 資料庫檢視 / 新手教學）
