...
KNOWN_SPLITS: dict[tuple[str, str], Sequence[tuple[str, float]]] = {
    ...
    ("TW", "00663L"): (("2025-06-11", 1.0 / 6.0),),
    # Reverse-split events for leveraged / inverse ETFs.
    ("TW", "00676R"): (("2025-02-19", 6.0),),
    ("TW", "00673R"): (("2025-10-22", 4.0),),
    ("TW", "00706L"): (("2025-10-22", 4.0),),
    ("TW", "00715L"): (("2025-12-10", 2.0),),
}
